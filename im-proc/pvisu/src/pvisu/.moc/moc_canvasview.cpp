...
static const char qt_meta_stringdata_CanvasView[] = {
    "CanvasView\0\0zoom(bool)\0update()\0"
};
...
void CanvasView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->zoom((*reinterpret_cast< bool(*)>(_a[1]))); break;
...
const QMetaObject CanvasView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CanvasView,
...
void *CanvasView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Viewer"))
        return static_cast< Viewer*>(const_cast< CanvasView*>(this));
