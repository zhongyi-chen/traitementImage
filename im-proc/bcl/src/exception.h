 ...
 * Copyright (C) 1996, 98, 99, 02 Achille Braquelaire (achille@labri.fr)
 * 
...
extern void exception_block_signals(void);
extern void exception_restaure_signals(void);

#else

#define exception_block_signals() ((void)0)
#define exception_restaure_signals() ((void)0)
...
#define RAISE(_E_,_M_) \
( exception_block_signals(), \
  exception_raise(EXCEPTION_INTERNAL_NAME(_E_), _M_, __FILE__, __LINE__) )
